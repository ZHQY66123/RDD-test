...
from .d2_ddim import sample_ddim
...
class DiffusionProcess(nn.Module):
    ...
    def sample_with_ddim(self, model, x_T, steps=None, eta=0.0):
        return sample_ddim(self, model, x_T, steps=steps, eta=eta, device=x_T.device)
